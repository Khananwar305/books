# Contributing to Viti Books

If you are a Viti Books user and want to contribute to improving it _without
writing code_, there are several things you can do:

- **Inform us of issues** you face while using Viti Books by [raising issues](https://github.com/vitibook/books/issues/new).
- **Add a language** you would like to use Viti Books in by [contributing translation](https://github.com/vitibook/books/wiki/Contributing-Translations).
- **Share your thoughts** on Viti Books by joining our [Telegram group](https://t.me/vitibooks).
- **Use Viti Books** for your accounting requirements and tell people about it.

---

If you want to contribute code to Viti Books, please go through the following sections for tips and guidelines:
...
A few rules of thumb to ensure that you're contributing maintainable code to Viti Books:
...
- **Rebase don't merge**: Merge commits are ugly and should be used only to
  merge a large PR.
- **Format your code**: Viti Books uses `prettier` and `eslint` rules for code
...
We strive to make Viti Books as easy and simple to use as possible, and
