...
<img src="https://vitibook.io/files/books.png" alt="Viti Books logo" width="80"/>
...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/vitibook/books)](https://github.com/vitibook/books/releases)
![Platforms](https://img.shields.io/badge/platform-mac%2C%20windows%2C%20linux-yellowgreen)
[![Publish](https://github.com/vitibook/books/actions/workflows/publish.yml/badge.svg)](https://github.com/vitibook/books/actions/workflows/publish.yml)

</div>

<div align="center">
<img src="https://user-images.githubusercontent.com/29507195/207267857-4ae48890-3fb2-4046-80cf-3256b46c72a0.png" alt="Viti Books Preview"/>
</div>
<br />
<div align="center">
	<a href="https://vitibook.io/books">Website</a>
	-
	<a href="https://docs.vitibook.io/books">Documentation</a>
</div>

## Viti Books

Viti Books is an open-source accounting software aimed at simplifying financial management for businesses. With its clean and user-friendly interface, it streamlines accounting tasks for small and medium-sized enterprises, offering a seamless solution for modern businesses to manage their finances with ease.
...
Viti Books addresses a market gap where small businesses face expensive, complex accounting tools. It offers an intuitive, open-source solution that combines simplicity with essential features, empowering businesses to manage finances effectively—even offline.
...
- **Vue.js**: In Viti Books, Vue.js powers the front-end, enabling a reactive and component-based UI. It ensures seamless interactions and dynamic updates, giving users a modern, responsive experience.

- **Electron**: Electron is used to package Viti Books as a standalone desktop application, allowing it to run offline and provide a native-like experience across Windows, macOS, and Linux.

- **SQLite**: Viti Books uses SQLite as its local database. All financial data, transactions, and configurations are stored securely in an SQLite file on the user's machine.
...
setup Viti Books for development and building:
...
To run Viti Books in development mode (with hot reload, etc):
...
visiting `chrome://inspect` while Viti Books is running in dev mode.

See more [here](https://www.electronjs.org/docs/latest/tutorial/debugging-main-process#external-debuggers).

#### Build

To build Viti Books and create an installer:
...
If you want to contribute to Viti Books, please check our [Contribution Guidelines](https://github.com/vitibook/books/blob/master/.github/CONTRIBUTING.md). There are many ways you can contribute even if you don't code:
...
- [Telegram Group](https://t.me/vitibooks): Used for discussions and decisions regarding everything Viti Books.
