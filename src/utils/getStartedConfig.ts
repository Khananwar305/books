      ...
      items: [
        {
          ...
          documentation: 'https://docs.vitibook.io/books/chart-of-accounts',
        },
        {
          ...
          documentation: 'https://docs.vitibook.io/books/setup-opening-balances',
        },
        {
          key: 'Add Taxes',
          label: t`Add Taxes`,
          ...
          documentation:
            'https://docs.vitibook.io/books/create-initial-entries#add-taxes',
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          documentation:
            'https://docs.vitibook.io/books/create-initial-entries#add-sales-items',
        },
        {
          key: 'Add Customers',
          ...
          documentation:
            'https://docs.vitibook.io/books/create-initial-entries#add-customers',
        },
        {
          ...
          documentation: 'https://docs.vitibook.io/books/sales-invoices',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          documentation:
            'https://docs.vitibook.io/books/purchase-invoices#creating-purchase-invoices',
        },
      ],
    },
  ];
